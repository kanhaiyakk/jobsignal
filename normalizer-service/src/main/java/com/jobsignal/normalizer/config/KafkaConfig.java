package com.jobsignal.normalizer.config;
...
public class KafkaConfig {
    ...
    private String normalizedListingsTopic;

    @Value("${kafka.topics.failed-listings}")
    private String failedListingsTopic;

    @Bean
    public NewTopic normalizedListingsTopic() {
        return TopicBuilder.name(normalizedListingsTopic).partitions(3).replicas(1).build();
    }
