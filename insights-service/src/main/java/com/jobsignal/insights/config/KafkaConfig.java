...
public class KafkaConfig {
    ...
    @Value("${kafka.topics.insights-generated}")
    private String insightsGeneratedTopic;
    ...
    public NewTopic insightsGeneratedTopic() {
        return TopicBuilder.name(insightsGeneratedTopic).partitions(1).replicas(1).build();
    }
